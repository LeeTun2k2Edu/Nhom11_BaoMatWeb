...
<script
	src="https://cdn.tiny.cloud/1/uo6yc026r4yvezeacop2xvdc5a8yullaazbbaoxqk3h78755/tinymce/6/tinymce.min.js"
...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<form method="post" action="Ad_AddProductControl?action=${action}"
							...
							<div class="col-md-12">
								<div class="card card-primary">
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label>Giá gốc</label> <input type="number" min="0"
												max="100000000000" step="1" class="form-control"
												name="giagoc" value="${sanPham.giaGoc}" />
										</div>
										<div class="form-group">
											<label>Giá bán thường</label> <input type="number" min="0"
												max="100000000000" step="1" class="form-control"
												name="giabanthuong" value="${sanPham.giaBanThuong}" />
										</div>
										<div class="form-group">
											<label>Giá khuyến mãi</label> <input type="number" min="0"
												max="100000000000" step="1" class="form-control"
										...
										<div class="form-group">
											<label>Danh mục</label> <select
												...
												<c:forEach var="o" items="${listDanhMuc}">
													<option value="${o.maDM}"
														${o.maDM == sanPham.maDM ? 'selected' : ''}>${o.tenDM}</option>
												</c:forEach>
											</select>
										</div>
	...
	<script>
		...
		function uploadFile() {
			...
			await
			fetch('/admin/Ad_AddProductControl', {
				method : "POST",
				body : formData
			});
	...
	<script
		src="${root}AdminF/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
	<!-- AdminLTE App -->
